  ...
  const leadershipOverview = [
    {
      title: 'INNOVATION',
      description:
        'Fostering creative thinking and problem-solving through an adaptive curriculum that embraces the latest trends and technologies.',
      image: '/leadership-team/logos/bulb.png',
    },
    {
      title: 'GLOBAL CITIZENSHIP',
      description:
        'Enhancing international awareness and responsibility by involving students in global issues and international programs.',
      image: '/leadership-team/logos/globe-people.png',
    },
    {
      title: 'COMPASSIONATE CAREGIVING',
      description:
        'Cultivating empathy and kindness through community service and social responsibility projects.',
      image: '/leadership-team/logos/hand-heart.png',
    },
    {
      title: 'NURTURING UNIQUENESS',
      description:
        "Supporting children's genetic potential by providing a nurturing environment that enhances talent and intelligence.",
      image: '/leadership-team/logos/hand-plant.png',
    },
    {
      title: 'CULTURAL CONNECTION',
      description:
        'Immersing students in diverse cultural experiences to build self-awareness, empathy, and a strong sense of identity and global citizenship.',
      image: '/leadership-team/logos/hand-people.png',
    },
  ];
  ...
  return (
    <main className='min-h-screen'>
      ...
      <div className='flex flex-col'>
        ...
        <div className='grid grid-cols-1 gap-6 bg-sky-600 px-4 py-12 text-center text-white sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5'>
          {leadershipOverview.map((item, index) => (
            <div key={index} className='flex flex-row items-start gap-4 text-left'>
              <Image
                src={item.image}
                alt={item.title}
                width={40}
